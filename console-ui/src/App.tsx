...
function RecentTasks(props: { operations: Operation[]; toggle: () => void }) { return <div class="grid h-full min-h-0 grid-rows-[36px_minmax(0,1fr)] bg-card" data-testid="recent-tasks"><TasksBar operations={props.operations} open toggle={props.toggle} /><div class="min-h-0 overflow-auto"><OperationTable operations={props.operations.slice(-8)} /></div></div> }
